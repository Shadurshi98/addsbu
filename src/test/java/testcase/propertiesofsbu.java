...
public class propertiesofsbu extends initial {
	...
	public void uiOfAddSbu() {
		testCase = extent.createTest(
				"STEP-01 CHECKING UI OF ADDSBU BUTTON(enable,visible,background-color,padding,font-family,color,font-size,"
						+ "text-spelling,border-color,border-radius,font-weight,cursor,opacity,box-shadow");

		boolean Value1 = driver.findElement(By.xpath(
...
///////// properties of addsbu modal
	...
	public void uioftextboxsbu() {
		testCase = extent.createTest("STEP-04 CHECKING THE UI OF TEXTBOX OF SBU(PlaceHolder,Visibility,Enablity,Postion,Background-color,Border-color,Length,Width,Border Color,Font style,Font Size,Font-color)");
		try
	...
	public void validationoftextboxsbu() {
		testCase = extent.createTest("STEP-05 CHECKING THE VALIDATION OF TEXTBOX OF SBU");

	}

	public void uioftextdescription() {
		testCase = extent.createTest("STEP-06 CHECKING THE UI OF TEXTDESCRIPTION(PlaceHolder,Visibility,Enablity,Postion,Background-color,Border-color,Length,Width,Border Color,Font style,Font Size,Font-color)");
